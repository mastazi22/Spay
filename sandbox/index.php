...
<div id="container">
  ...
  <div id="main_container">
    ...
    <a href="request_item.php" style="padding-left: 10px;padding-right: 10px;font-weight: bold;">Send Request</a> <a href="login.php" style="padding-left: 10px;padding-right: 10px; font-weight: bold;">MIS Login</a>
