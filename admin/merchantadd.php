...
if(isset($_POST['username']) and $_POST['password']!="" and $_POST['merchant_ip']!="" and  $_POST['merchant_domain']!="" and  $_POST['unique_id_code']!="" )
{
    ...
    $query_sql="insert into sp_merchants (id, username, password, description,merchant_ip,merchant_domain,unique_id_code, isactive) values('','$_POST[username]','$password','$_POST[description]','$_POST[merchant_ip]','$_POST[merchant_domain]','$_POST[unique_id_code]','$_POST[isactive]')";
 
  $res=mysqli_query($GLOBALS["___mysqli_sm"], $query_sql);
    
        if($res)
        {
        $error_flag="Merchant added successfully.";
        }
        else
        {
    ...
    <fieldset>
        ...
        <ol>
            ...
            <li>
                ...
                <input name="merchant_ip" type="text" class="controls" value="" size="20" maxlength="40"><span class="RequiredFieldValidator1">*</span>
               
            </li>

			  <li>
                <label>Merchant Domain</label>
                <input name="merchant_domain" type="text" class="controls" value="" size="20" maxlength="40"><span class="RequiredFieldValidator1">*</span>
               
            </li>
			 <li>
                <label>Unique Code</label>
                <input name="unique_id_code" type="text" class="controls" value="" size="20" maxlength="40"><span class="RequiredFieldValidator1">*</span>
	 ...
	 <form id="form1" name="form1" method="post" action="merchantedit.php" autocomplete="off">
    <fieldset>
		
           <legend>Please Select Merchant For Update</legend>
        <ol>
            <li>
                <?php if($error_flag!=""){echo $error_flag;} ?>
               </li>
