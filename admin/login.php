...
if(isset($_REQUEST['name'])){
    ...
    $response=checkAdmin($name,$password);
...
<div>
	<div id="login-box">
	      <div>
                  ...
                  <div id="logo_img_right"><div id="merchantlogo"><img src="./img/sand-box-logo.jpg" alt="SHURJOMUKHI"></div></div>
		  <br />
		  </div>
		  <br />
		  <div style="clear:both;text-align:center;">Welcome to Shurjopay Dashboard.</div>
		  <br />
