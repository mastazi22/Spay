...
if(!isset($_POST['merchantlist']) and !isset($_POST['id']))
{
...
if(isset($_POST['id']))
{
    ...
    $query_sql="update sp_merchants set ";
	...
	if(isset($_POST['description'])){$query_sql.=", description='".$_POST['description']."'";}
	if(isset($_POST['merchant_ip'])){$query_sql.=", merchant_ip='".$_POST['merchant_ip']."'";}
	if(isset($_POST['merchant_domain'])){$query_sql.=", merchant_domain='".$_POST['merchant_domain']."'";}
	if(isset($_POST['unique_id_code'])){$query_sql.=", unique_id_code='".$_POST['unique_id_code']."'";}
  ...
  $res=mysqli_query($GLOBALS["___mysqli_sm"], $query_sql);
        ...
        if($res)
        {
        $error_flag="Merchant updated successfully.";
        }
        else
        {
...
<div style="float:right;font-size:15px" class="menu"><a href="merchantadd.php"><span >Back</span></a></div>
		<div class="content">

			<div class="item" style="padding-left:60px;">
			<?php  
 $query_sql="select * from sp_merchants where id='$_POST[merchantlist]'";
$res=mysqli_query($GLOBALS["___mysqli_sm"], $query_sql);
$data=mysql_fetch_object($res);

?>
	 
   <form id="form2" name="form2" method="post" action="merchantedit.php" autocomplete="off">
    <fieldset>
        ...
        <ol>
            ...
            <li>
                ...
                <input name="merchant_ip" type="text" class="controls"  size="20" maxlength="40" value="<?php echo $data->merchant_ip; ?>"><span class="RequiredFieldValidator1">*</span>
               
            </li>

			  <li>
                <label>Merchant Domain</label>
                <input name="merchant_domain" type="text" class="controls"  size="20" maxlength="40" value="<?php echo $data->merchant_domain; ?>"><span class="RequiredFieldValidator1">*</span>
               
            </li>
			 <li>
                <label>Unique Code</label>
                <input name="unique_id_code" type="text" class="controls"  size="20" maxlength="40" value='<?php echo $data->unique_id_code; ?>'><span class="RequiredFieldValidator1">*</span>
