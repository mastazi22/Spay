...
?>
<div id="banklogo" style="float: left; width: 33%; padding-left: 2%; display: inline; margin-left: 0px; position: relative; margin-top: 10px;"><img src="./img/sp_logo.jpg" alt="shurjoPay" height="50"></div>
<div id="bkashlogo" style="width: 30%; float: left; display: inline; margin-top: 10px; text-align: center;"><img src="./img/dbbl_mobile_wallet.png" alt="shurjoPay" height="50"></div>
