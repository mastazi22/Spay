...
if(count($_POST)==0)
{
    ...
    // TJBD MODIFICATION
    if( isset($_SESSION['ORDER_DETAILS']['bank']) && 
        $_SESSION['ORDER_DETAILS']['bank'] == 'trust' &&
        isset($_SESSION['ORDER_DETAILS']['uniqID']) &&        
        substr($_SESSION['ORDER_DETAILS']['uniqID'],0,3) == 'JBD'
    ) 
    {
        $cityBankOk = FALSE;
        $eblBankOk  = FALSE; 
        $dbblBankOk = FALSE;        
        $mobileWalletOk = FALSE;
        $onlineBankOk = FALSE;
        $mcashOk = FALSE;
        $upayOk = FALSE;
        $tbmmOk = TRUE;
    ...
    else if ( isset($_SESSION['ORDER_DETAILS']['uniqID']) &&        
        substr($_SESSION['ORDER_DETAILS']['uniqID'],0,3) == 'JBD'
    ) 
    {
        $eblBankOk  = FALSE; 
            ...
            <div class="wthree_tabs">
                <div id="horizontalTab">
                    <ul class="resp-tabs-list">
                            ...
                            onClick="this.disabled=true;"
                            <?php endif; ?> 
                            ><img src="option-images/trust_bank_icon.png" class="bank-icon" alt=" "/> Trust Bank</li>
                            <li 

                            <?php if(!$mobileWalletOk):?>
                            class="disabled"
                            onClick="this.disabled=true;"
                            <?php endif; ?>
                            style="font-size:12px;"><img src="option-images/mobile_wallet_icon.png" class="bank-icon"  alt=" "/> Mobile Wallet</li>
                            <li  
                            <?php if(!$onlineBankOk):?>
                            class="disabled"
                            onClick="this.disabled=true;"
                            <?php endif; ?>
                            style="font-size:12px;"><img src="option-images/online_banking_icon.png" class="bank-icon"  alt=" "/> Online Banking</li>
                    </ul>
