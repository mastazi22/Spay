	...
	public function __construct() {
		...
		switch($_SERVER["SERVER_NAME"]) {
		 	...
		 	break;
		  	...
		  	case 'localhost':
				$this->ret_url = "http://".$_SERVER["SERVER_NAME"]."/shurjopaysr/epay/brac/decrypt.php";
		  	break;
	 	...
	 	if(substr( $_SESSION['ORDER_DETAILS']['uniqID'],0,'7')=="PPT1016"){
	 		$this->mer_id = "SJTELETALK";
	 	}
	 	else if(substr( $_SESSION['ORDER_DETAILS']['uniqID'],0,'9')=="PPTAIRTEL"){
	 		$this->mer_id = "SJAIRTEL";
	 	}
	 	else if(substr( $_SESSION['ORDER_DETAILS']['uniqID'],0,'12')=="PPTKASPERSKY"){
	 		$this->mer_id = "SJKASPERSKY";
	 	}
	 	else if(substr( $_SESSION['ORDER_DETAILS']['uniqID'],0,'8')=="PPTQUBEE"){
	 		$this->mer_id = "SJQUBEE";
	 	}
	 	else if(substr( $_SESSION['ORDER_DETAILS']['uniqID'],0,'6')=="PPTBCW"){
	 		$this->mer_id = "SJBALAKA";
	 	}
	 	else if(substr( $_SESSION['ORDER_DETAILS']['uniqID'],0,'8')=="PPTBLINK"){
	 		$this->mer_id = "SJBLINK";
	 	}
	 	else if(substr( $_SESSION['ORDER_DETAILS']['uniqID'],0,'3')=="SRJ"){
	 		$this->mer_id = "SHURJORAJJO";
	 	}
	 	else{
	 		$this->mer_id = "SHURJOMUKHI";
	 	}
